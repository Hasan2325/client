...
def Home():
	...
	print("\t\t\t\t\t\t WELCOME TO TVA\n")
	print("\t\t\t\t\t **Menu**\n")
	print("\t\t\t Press 1 for Booking\n")
	print("\t\t\t Press 2 for Rooms Info\n")
	print("\t\t\t Press 3 for Room Service(Menu Card)\n")
	print("\t\t\t Press 4 for Payment\n")
	print("\t\t\t Press 5 for Record\n")
	print("\t\t\t Press 0 for Exit\n")

	menuOption=int(input("Enter: "))
